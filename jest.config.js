...
module.exports = {
  ...
  // cacheDirectory: "C:\\Users\\Aldi Prayogi\\AppData\\Local\\Temp\\jest",
  ...
  // ignored files using an array of glob patterns
  // forceCoverageMatch: [],
  ...
  // A set of global variables that
  ...
  // your CPU amount + 1 as the maximum worker
  ...
  // names or to arrays of module names that
  // allow to stub out resources with a single module
  // moduleNameMapper: {},

  // An array of regexp pattern strings,
  // matched against all module paths before considered 'visible' to the module
  // loader
  ...
  // Setting this value to "fake" allows the
  ...
  // An array of regexp pattern strings that
  // are matched against all modules before
  // he module loader will automatically return a mock for them
